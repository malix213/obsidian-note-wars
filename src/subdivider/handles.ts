...
async function handle_file(plugin: IdeaEmergencePlugin, file: TFile, depth: number, deleteOrigFile: boolean, autoOverride: boolean, showModal: boolean = false) {
...
async function handle_selection(plugin: IdeaEmergencePlugin, selectedText: string) {
